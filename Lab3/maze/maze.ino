...
{ 
  	...
  	{    
	    ...
	    //left side is not a wall or visited cell
	    ...
	    //cell in front is not a wall or visited cell
	    ...
	    //right side is not a wall or visited cell
...
{ 
	...
	{ 
		//Straight Forward without Proportional feedback  
...
void uTurn()  //180 degree U turn
{
	leftServo.writeMicroseconds(1550); 
	rightServo.writeMicroseconds(1550);
}

// calculate distance from right sensor to wall
...
// calculate distance from front sensor to wall
...
// calculate distance from the left sensor to wall
